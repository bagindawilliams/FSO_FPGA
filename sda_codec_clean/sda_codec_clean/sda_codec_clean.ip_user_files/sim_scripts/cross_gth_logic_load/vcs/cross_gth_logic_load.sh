...
#
# Script generated by Vivado on Tue Aug 18 15:10:07 KST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cross_gth_logic_load.sh
...
#
# Usage        : cross_gth_logic_load.sh
#                cross_gth_logic_load.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cross_gth_logic_load.sh [-rerun]
#                cross_gth_logic_load.sh [-reset_run]
#                cross_gth_logic_load.sh [-clean]
#                cross_gth_logic_load.sh [-reset_log]
#                cross_gth_logic_load.sh [-help]
#
...
#                script (type 'cross_gth_logic_load.sh -help' for more information).
#
...
# script info
echo -e "cross_gth_logic_load.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cross_gth_logic_load.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../2025_vivado/2025.2/data/rsb/busdef" \
  ...
  vlogan -work fifo_generator_v13_2_14 $vlogan_opts +v2k +incdir+"../../../../../../../../2025_vivado/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../2025_vivado/2025.2/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cross_gth_logic_load xil_defaultlib.glbl -o cross_gth_logic_load_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cross_gth_logic_load_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/rofiq/Documents/legacy/FSO_FPGA-main/sda_codec_clean/sda_codec_clean/sda_codec_clean.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key cross_gth_logic_load_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cross_gth_logic_load_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cross_gth_logic_load.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cross_gth_logic_load.sh [-help]\n\
Usage: cross_gth_logic_load.sh [-step]\n\
Usage: cross_gth_logic_load.sh [-lib_map_path]\n\
Usage: cross_gth_logic_load.sh [-rerun]\n\
Usage: cross_gth_logic_load.sh [-reset_run]\n\
Usage: cross_gth_logic_load.sh [-clean]\n\
Usage: cross_gth_logic_load.sh [-reset_log]\n\
Usage: cross_gth_logic_load.sh [-keep_index]\n\
Usage: cross_gth_logic_load.sh [-noclean_files]\n\n\
