...
#
# Script generated by Vivado on Tue Aug 18 15:10:05 KST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cross_logic_gth.sh
...
#
# Usage        : cross_logic_gth.sh
#                cross_logic_gth.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cross_logic_gth.sh [-rerun]
#                cross_logic_gth.sh [-reset_run]
#                cross_logic_gth.sh [-clean]
#                cross_logic_gth.sh [-reset_log]
#                cross_logic_gth.sh [-help]
#
...
#                script (type 'cross_logic_gth.sh -help' for more information).
#
...
# script info
echo -e "cross_logic_gth.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cross_logic_gth.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cross_logic_gth xil_defaultlib.glbl -o cross_logic_gth_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cross_logic_gth_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cross_logic_gth_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cross_logic_gth_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cross_logic_gth.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cross_logic_gth.sh [-help]\n\
Usage: cross_logic_gth.sh [-step]\n\
Usage: cross_logic_gth.sh [-lib_map_path]\n\
Usage: cross_logic_gth.sh [-rerun]\n\
Usage: cross_logic_gth.sh [-reset_run]\n\
Usage: cross_logic_gth.sh [-clean]\n\
Usage: cross_logic_gth.sh [-reset_log]\n\
Usage: cross_logic_gth.sh [-keep_index]\n\
Usage: cross_logic_gth.sh [-noclean_files]\n\n\
