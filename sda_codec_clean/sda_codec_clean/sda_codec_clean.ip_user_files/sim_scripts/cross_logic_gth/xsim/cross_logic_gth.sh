...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L fifo_generator_v13_2_14 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cross_logic_gth xil_defaultlib.cross_logic_gth xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cross_logic_gth -key {Behavioral:sim_1:Functional:cross_logic_gth} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cross_logic_gth.wdb xsim.dir libdpi.so)
