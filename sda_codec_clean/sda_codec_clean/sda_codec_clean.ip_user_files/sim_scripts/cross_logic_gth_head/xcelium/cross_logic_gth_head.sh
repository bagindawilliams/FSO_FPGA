...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../2025_vivado/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work fifo_generator_v13_2_14 $xmvlog_opts +incdir+"../../../../../../../../2025_vivado/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../2025_vivado/2025.2/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cross_logic_gth_head xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cross_logic_gth_head -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/rofiq/Documents/legacy/FSO_FPGA-main/sda_codec_clean/sda_codec_clean/sda_codec_clean.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cross_logic_gth_head_sc.so .tmp_log xcelium_lib waves.shm c.obj)
