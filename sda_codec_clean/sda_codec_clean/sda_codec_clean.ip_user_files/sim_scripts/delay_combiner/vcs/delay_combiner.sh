...
#
# Script generated by Vivado on Tue Aug 18 15:10:06 KST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : delay_combiner.sh
...
#
# Usage        : delay_combiner.sh
#                delay_combiner.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                delay_combiner.sh [-rerun]
#                delay_combiner.sh [-reset_run]
#                delay_combiner.sh [-clean]
#                delay_combiner.sh [-reset_log]
#                delay_combiner.sh [-help]
#
...
#                script (type 'delay_combiner.sh -help' for more information).
#
...
# script info
echo -e "delay_combiner.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./delay_combiner.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.delay_combiner xil_defaultlib.glbl -o delay_combiner_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./delay_combiner_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key delay_combiner_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc delay_combiner_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./delay_combiner.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: delay_combiner.sh [-help]\n\
Usage: delay_combiner.sh [-step]\n\
Usage: delay_combiner.sh [-lib_map_path]\n\
Usage: delay_combiner.sh [-rerun]\n\
Usage: delay_combiner.sh [-reset_run]\n\
Usage: delay_combiner.sh [-clean]\n\
Usage: delay_combiner.sh [-reset_log]\n\
Usage: delay_combiner.sh [-keep_index]\n\
Usage: delay_combiner.sh [-noclean_files]\n\n\
