...
#
# Script generated by Vivado on Tue Aug 18 15:10:00 KST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : serdes_assembler.sh
...
#
# Usage        : serdes_assembler.sh
#                serdes_assembler.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                serdes_assembler.sh [-rerun]
#                serdes_assembler.sh [-reset_run]
#                serdes_assembler.sh [-clean]
#                serdes_assembler.sh [-reset_log]
#                serdes_assembler.sh [-help]
#
...
#                script (type 'serdes_assembler.sh -help' for more information).
#
...
# script info
echo -e "serdes_assembler.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./serdes_assembler.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.serdes_assembler xil_defaultlib.glbl -o serdes_assembler_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./serdes_assembler_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key serdes_assembler_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc serdes_assembler_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./serdes_assembler.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: serdes_assembler.sh [-help]\n\
Usage: serdes_assembler.sh [-step]\n\
Usage: serdes_assembler.sh [-lib_map_path]\n\
Usage: serdes_assembler.sh [-rerun]\n\
Usage: serdes_assembler.sh [-reset_run]\n\
Usage: serdes_assembler.sh [-clean]\n\
Usage: serdes_assembler.sh [-reset_log]\n\
Usage: serdes_assembler.sh [-keep_index]\n\
Usage: serdes_assembler.sh [-noclean_files]\n\n\
