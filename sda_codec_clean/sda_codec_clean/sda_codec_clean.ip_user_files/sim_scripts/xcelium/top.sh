...
design_libs_elab="-libname xpm -libname fifo_generator_v13_2_14 -libname xil_defaultlib -libname blk_mem_gen_v8_4_12 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm fifo_generator_v13_2_14 xil_defaultlib blk_mem_gen_v8_4_12)
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  xmvlog -work fifo_generator_v13_2_14 $xmvlog_opts +incdir+"../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  xmvlog -work blk_mem_gen_v8_4_12 $xmvlog_opts +incdir+"../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
