...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xpm -L fifo_generator_v13_2_14 -L blk_mem_gen_v8_4_12 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot top xil_defaultlib.top xil_defaultlib.glbl -log elaborate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm fifo_generator_v13_2_14 blk_mem_gen_v8_4_12)
