...
synth_design -top cross_gth_logic_head -part xcku060-ffva1156-2-i -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix cross_gth_logic_head_ cross_gth_logic_head.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ cross_gth_logic_head_stub.v
 lappend ipCachedFiles cross_gth_logic_head_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ cross_gth_logic_head_stub.vhdl
 lappend ipCachedFiles cross_gth_logic_head_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ cross_gth_logic_head_sim_netlist.v
 lappend ipCachedFiles cross_gth_logic_head_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ cross_gth_logic_head_sim_netlist.vhdl
 lappend ipCachedFiles cross_gth_logic_head_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp cross_gth_logic_head.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips cross_gth_logic_head]
 }
...
rename_ref -prefix_all cross_gth_logic_head_
...
OPTRACE "cross_gth_logic_head_synth_1" END { }
