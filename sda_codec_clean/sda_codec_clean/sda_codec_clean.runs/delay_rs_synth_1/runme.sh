...
HD_PWD='/home/williams/MYFPGA/FPGA Final/sda_codec_clean/sda_codec_clean/sda_codec_clean.runs/delay_rs_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log delay_rs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source delay_rs.tcl
