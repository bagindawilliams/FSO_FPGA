...
HD_PWD='/home/williams/MYFPGA/FPGA Final/sda_codec_clean/sda_codec_clean/sda_codec_clean.runs/serdes_framer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serdes_framer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source serdes_framer.tcl
