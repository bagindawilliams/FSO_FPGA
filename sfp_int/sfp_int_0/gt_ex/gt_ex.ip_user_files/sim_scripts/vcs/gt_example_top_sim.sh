...
#
# Script generated by Vivado on Tue Aug 11 23:51:07 KST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : gt_example_top_sim.sh
...
#
# Usage        : gt_example_top_sim.sh
#                gt_example_top_sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gt_example_top_sim.sh [-rerun]
#                gt_example_top_sim.sh [-reset_run]
#                gt_example_top_sim.sh [-clean]
#                gt_example_top_sim.sh [-reset_log]
#                gt_example_top_sim.sh [-help]
#
...
#                script (type 'gt_example_top_sim.sh -help' for more information).
#
...
# script info
echo -e "gt_example_top_sim.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gt_example_top_sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../../../../FPGA\\ Training\\ Data\\ Etri_fso/sfp_int/sfp_int_0/gt_ex/imports/gt_example_bit_sync.v" \
  "../../../../../../../FPGA\\ Training\\ Data\\ Etri_fso/sfp_int/sfp_int_0/gt_ex/imports/gt_example_gtwiz_userclk_rx.v" \
  "../../../../../../../FPGA\\ Training\\ Data\\ Etri_fso/sfp_int/sfp_int_0/gt_ex/imports/gt_example_gtwiz_userclk_tx.v" \
  "../../../../../../../FPGA\\ Training\\ Data\\ Etri_fso/sfp_int/sfp_int_0/gt_ex/imports/gt_example_init.v" \
  "../../../../../../../FPGA\\ Training\\ Data\\ Etri_fso/sfp_int/sfp_int_0/gt_ex/imports/gt_example_reset_sync.v" \
  "../../../../../../../FPGA\\ Training\\ Data\\ Etri_fso/sfp_int/sfp_int_0/gt_ex/imports/gt_example_top.v" \
  "../../../../../../../FPGA\\ Training\\ Data\\ Etri_fso/sfp_int/sfp_int_0/gt_ex/imports/gt_example_wrapper.v" \
  "../../../../../../../FPGA\\ Training\\ Data\\ Etri_fso/sfp_int/sfp_int_0/gt_ex/imports/gt_example_top_sim.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.gt_example_top_sim xil_defaultlib.glbl -o gt_example_top_sim_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./gt_example_top_sim_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key gt_example_top_sim_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc gt_example_top_sim_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gt_example_top_sim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gt_example_top_sim.sh [-help]\n\
Usage: gt_example_top_sim.sh [-step]\n\
Usage: gt_example_top_sim.sh [-lib_map_path]\n\
Usage: gt_example_top_sim.sh [-rerun]\n\
Usage: gt_example_top_sim.sh [-reset_run]\n\
Usage: gt_example_top_sim.sh [-clean]\n\
Usage: gt_example_top_sim.sh [-reset_log]\n\
Usage: gt_example_top_sim.sh [-keep_index]\n\
Usage: gt_example_top_sim.sh [-noclean_files]\n\n\
