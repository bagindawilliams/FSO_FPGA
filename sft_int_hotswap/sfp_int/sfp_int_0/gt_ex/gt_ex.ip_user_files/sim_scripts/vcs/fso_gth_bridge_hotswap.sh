...
#
# Script generated by Vivado on Fri Aug 28 16:37:25 KST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fso_gth_bridge_hotswap.sh
...
#
# Usage        : fso_gth_bridge_hotswap.sh
#                fso_gth_bridge_hotswap.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fso_gth_bridge_hotswap.sh [-rerun]
#                fso_gth_bridge_hotswap.sh [-reset_run]
#                fso_gth_bridge_hotswap.sh [-clean]
#                fso_gth_bridge_hotswap.sh [-reset_log]
#                fso_gth_bridge_hotswap.sh [-help]
#
...
#                script (type 'fso_gth_bridge_hotswap.sh -help' for more information).
#
...
design_libs=(xpm gtwizard_ultrascale_v1_7_22 xil_defaultlib)

# simulation root library directory
sim_lib_dir="vcs_lib"

# script info
echo -e "fso_gth_bridge_hotswap.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fso_gth_bridge_hotswap.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" +incdir+"../../../imports" \
  ...
  vlogan -work gtwizard_ultrascale_v1_7_22 $vlogan_opts +v2k +incdir+"../../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" +incdir+"../../../imports" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" +incdir+"../../../imports" \
  "../../../gt_ex.gen/sources_1/ip/gth_fso_64b66b/sim/gtwizard_ultrascale_v1_7_gthe3_channel.v" \
  "../../../gt_ex.gen/sources_1/ip/gth_fso_64b66b/sim/gth_fso_64b66b_gthe3_channel_wrapper.v" \
  "../../../gt_ex.gen/sources_1/ip/gth_fso_64b66b/sim/gtwizard_ultrascale_v1_7_gthe3_common.v" \
  "../../../gt_ex.gen/sources_1/ip/gth_fso_64b66b/sim/gth_fso_64b66b_gthe3_common_wrapper.v" \
  "../../../gt_ex.gen/sources_1/ip/gth_fso_64b66b/sim/gth_fso_64b66b_gtwizard_gthe3.v" \
  "../../../gt_ex.gen/sources_1/ip/gth_fso_64b66b/sim/gth_fso_64b66b_gtwizard_top.v" \
  "../../../gt_ex.gen/sources_1/ip/gth_fso_64b66b/sim/gth_fso_64b66b.v" \
  "../../../../../../../FPGA\\ Final/sfp_int/sfp_int_0/gt_ex/gt_ex.srcs/sources_1/new/error_inject_hotswap.v" \
  "../../../../../../../FPGA\\ Final/sfp_int/sfp_int_0/gt_ex/gt_ex.srcs/sources_1/new/fso_gth_bridge_hotswap.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fso_gth_bridge_hotswap xil_defaultlib.glbl -o fso_gth_bridge_hotswap_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fso_gth_bridge_hotswap_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/williams/MYFPGA/FPGA"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key fso_gth_bridge_hotswap_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fso_gth_bridge_hotswap_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fso_gth_bridge_hotswap.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fso_gth_bridge_hotswap.sh [-help]\n\
Usage: fso_gth_bridge_hotswap.sh [-step]\n\
Usage: fso_gth_bridge_hotswap.sh [-lib_map_path]\n\
Usage: fso_gth_bridge_hotswap.sh [-rerun]\n\
Usage: fso_gth_bridge_hotswap.sh [-reset_run]\n\
Usage: fso_gth_bridge_hotswap.sh [-clean]\n\
Usage: fso_gth_bridge_hotswap.sh [-reset_log]\n\
Usage: fso_gth_bridge_hotswap.sh [-keep_index]\n\
Usage: fso_gth_bridge_hotswap.sh [-noclean_files]\n\n\
