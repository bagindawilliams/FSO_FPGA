...
#
# Script generated by Vivado on Thu Aug 27 20:37:38 KST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_mux_eth_32.sh
...
#
# Usage        : tb_mux_eth_32.sh
#                tb_mux_eth_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_mux_eth_32.sh [-rerun]
#                tb_mux_eth_32.sh [-reset_run]
#                tb_mux_eth_32.sh [-clean]
#                tb_mux_eth_32.sh [-reset_log]
#                tb_mux_eth_32.sh [-help]
#
...
#                script (type 'tb_mux_eth_32.sh -help' for more information).
#
...
# script info
echo -e "tb_mux_eth_32.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_mux_eth_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../../../../FPGA\\ Final/sfp_int/sfp_int_0/gt_ex/gt_ex.srcs/sources_1/new/tb_mux_eth_32.v" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tb_mux_eth_32 xil_defaultlib.glbl -o tb_mux_eth_32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tb_mux_eth_32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tb_mux_eth_32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tb_mux_eth_32_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_mux_eth_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_mux_eth_32.sh [-help]\n\
Usage: tb_mux_eth_32.sh [-step]\n\
Usage: tb_mux_eth_32.sh [-lib_map_path]\n\
Usage: tb_mux_eth_32.sh [-rerun]\n\
Usage: tb_mux_eth_32.sh [-reset_run]\n\
Usage: tb_mux_eth_32.sh [-clean]\n\
Usage: tb_mux_eth_32.sh [-reset_log]\n\
Usage: tb_mux_eth_32.sh [-keep_index]\n\
Usage: tb_mux_eth_32.sh [-noclean_files]\n\n\
