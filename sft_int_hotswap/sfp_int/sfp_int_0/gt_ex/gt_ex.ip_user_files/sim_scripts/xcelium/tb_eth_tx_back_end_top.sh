...
compile()
{
  ...
  "../../../gt_ex.srcs/sources_1/new/eth_mac_packing_tx.v" \
  "../../../gt_ex.srcs/sources_1/new/eth_preamble_gen.v" \
  "../../../gt_ex.srcs/sources_1/new/eth_tx_back_end_top.v" \
  "../../../gt_ex.srcs/sources_1/new/mux_eth_32.v" \
  "../../../gt_ex.srcs/sources_1/new/xgmii_tx_formatter.v" \
  "../../../gt_ex.srcs/sources_1/new/tb_eth_tx_back_end_top.v" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tb_eth_tx_back_end_top xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tb_eth_tx_back_end_top -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tb_eth_tx_back_end_top_sc.so .tmp_log xcelium_lib waves.shm c.obj)
