...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xpm -L gtwizard_ultrascale_v1_7_22 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot fso_gth_bridge_hotswap xil_defaultlib.fso_gth_bridge_hotswap xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fso_gth_bridge_hotswap -key {Behavioral:sim_1:Functional:fso_gth_bridge_hotswap} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm gtwizard_ultrascale_v1_7_22)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fso_gth_bridge_hotswap.wdb xsim.dir libdpi.so)
