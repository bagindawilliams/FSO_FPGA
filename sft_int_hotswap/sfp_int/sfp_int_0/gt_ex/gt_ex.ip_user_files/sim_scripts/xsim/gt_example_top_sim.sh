...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xpm -L gtwizard_ultrascale_v1_7_22 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot gt_example_top_sim xil_defaultlib.gt_example_top_sim xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gt_example_top_sim -key {Behavioral:sim_1:Functional:gt_example_top_sim} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gt_example_top_sim.wdb xsim.dir libdpi.so)
