...
#
# Script generated by Vivado on Sat Aug 29 00:09:01 KST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_demux_preamble_hotswap.sh
...
#
# Usage        : tb_demux_preamble_hotswap.sh
#                tb_demux_preamble_hotswap.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_demux_preamble_hotswap.sh [-rerun]
#                tb_demux_preamble_hotswap.sh [-reset_run]
#                tb_demux_preamble_hotswap.sh [-clean]
#                tb_demux_preamble_hotswap.sh [-reset_log]
#                tb_demux_preamble_hotswap.sh [-help]
#
...
#                script (type 'tb_demux_preamble_hotswap.sh -help' for more information).
#
...
# script info
echo -e "tb_demux_preamble_hotswap.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_demux_preamble_hotswap.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../../imports" +incdir+"../../ipstatic" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../../imports" +incdir+"../../ipstatic" \
  "../../../../../../../FPGA\\ Final/sfp_int/sfp_int_0/gt_ex/gt_ex.srcs/sources_1/new/demux_preamble_hotswap.v" \
  "../../../../../../../FPGA\\ Final/sfp_int/sfp_int_0/gt_ex/gt_ex.srcs/sources_1/new/tb_demux_preamble_hotswap.v" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tb_demux_preamble_hotswap xil_defaultlib.glbl -o tb_demux_preamble_hotswap_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tb_demux_preamble_hotswap_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tb_demux_preamble_hotswap_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tb_demux_preamble_hotswap_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_demux_preamble_hotswap.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_demux_preamble_hotswap.sh [-help]\n\
Usage: tb_demux_preamble_hotswap.sh [-step]\n\
Usage: tb_demux_preamble_hotswap.sh [-lib_map_path]\n\
Usage: tb_demux_preamble_hotswap.sh [-rerun]\n\
Usage: tb_demux_preamble_hotswap.sh [-reset_run]\n\
Usage: tb_demux_preamble_hotswap.sh [-clean]\n\
Usage: tb_demux_preamble_hotswap.sh [-reset_log]\n\
Usage: tb_demux_preamble_hotswap.sh [-keep_index]\n\
Usage: tb_demux_preamble_hotswap.sh [-noclean_files]\n\n\
