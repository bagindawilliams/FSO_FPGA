...
design_libs_elab="-libname xpm -libname gtwizard_ultrascale_v1_7_22 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm gtwizard_ultrascale_v1_7_22 xil_defaultlib)
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" +incdir+"../../../imports" \
  ...
  xmvlog -work gtwizard_ultrascale_v1_7_22 $xmvlog_opts +incdir+"../../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" +incdir+"../../../imports" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" +incdir+"../../../imports" \
  ...
  "../../../gt_ex.srcs/sources_1/new/error_inject_hotswap.v" \
  "../../../gt_ex.srcs/sources_1/new/fso_gth_bridge_hotswap.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fso_gth_bridge_hotswap xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fso_gth_bridge_hotswap -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fso_gth_bridge_hotswap_sc.so .tmp_log xcelium_lib waves.shm c.obj)
