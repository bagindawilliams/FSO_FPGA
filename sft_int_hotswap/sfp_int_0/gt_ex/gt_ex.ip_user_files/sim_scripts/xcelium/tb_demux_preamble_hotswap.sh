...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../../imports" +incdir+"../../ipstatic" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../../2025.2/2025.2/data/rsb/busdef" +incdir+"../../../imports" +incdir+"../../ipstatic" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tb_demux_preamble_hotswap xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tb_demux_preamble_hotswap -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tb_demux_preamble_hotswap_sc.so .tmp_log xcelium_lib waves.shm c.obj)
