...
compile()
{
  ...
  "../../../gt_ex.srcs/sources_1/new/tb_mux_eth_32.v" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tb_mux_eth_32 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tb_mux_eth_32 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tb_mux_eth_32_sc.so .tmp_log xcelium_lib waves.shm c.obj)
