...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot tb_eth_tx_back_end_top xil_defaultlib.tb_eth_tx_back_end_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_eth_tx_back_end_top -key {Behavioral:sim_1:Functional:tb_eth_tx_back_end_top} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_eth_tx_back_end_top.wdb xsim.dir libdpi.so)
